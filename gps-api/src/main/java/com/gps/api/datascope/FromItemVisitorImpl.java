...
import com.gps.api.datascope.cond.TableCondition;
import com.gps.api.datascope.cond.UserConditionUtils;
                ...
                for (TableCondition tableCondition : test) {
                    ...
                    if ("between".equalsIgnoreCase(cond) || "not between".equalsIgnoreCase(cond)) {
                        ...
                        if ("1".equals(tableCondition.getFieldName())) {
                            expressions = new Expression[]{new LongValue(tableCondition.getFieldName()), new LongValue((Long)tableCondition.getFieldValue())};
                        } else {
